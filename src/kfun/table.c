...
void kf_clear()
{
    extern void kf_enc P((frame*, int, value*));
    extern void kf_enc_key P((frame*, int, value*));
    extern void kf_dec P((frame*, int, value*));
    extern void kf_dec_key P((frame*, int, value*));
    extern void kf_xcrypt P((frame*, int, value*));
    extern void kf_md5 P((frame*, int, value*));
    extern void kf_sha1 P((frame*, int, value*));
 ...
 */
static int kf_index(kf, l, h, name)
register kfunc *kf;
