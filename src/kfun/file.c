...
char p_restore_object[] = { C_TYPECHECKED | C_STATIC | C_LOCAL, T_NUMBER, 1,
			    T_STRING };
...
char p_write_file[] = { C_TYPECHECKED | C_VARARGS | C_STATIC | C_LOCAL,
			T_NUMBER, 3, T_STRING, T_STRING, T_NUMBER };
...
char p_read_file[] = { C_TYPECHECKED | C_VARARGS | C_STATIC | C_LOCAL,
		       T_STRING, 3, T_STRING, T_NUMBER, T_NUMBER };
...
# else
char p_rename_file[] = { C_TYPECHECKED | C_STATIC | C_LOCAL, T_NUMBER, 2,
			 T_STRING, T_STRING };
...
# else
char p_remove_file[] = { C_TYPECHECKED | C_STATIC | C_LOCAL, T_NUMBER, 1,
			 T_STRING };
...
# else
char p_make_dir[] = { C_TYPECHECKED | C_STATIC | C_LOCAL, T_NUMBER, 1,
		      T_STRING };
...
# else
char p_remove_dir[] = { C_TYPECHECKED | C_STATIC | C_LOCAL, T_NUMBER, 1,
			T_STRING };
